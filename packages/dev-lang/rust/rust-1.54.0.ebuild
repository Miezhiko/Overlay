...
IUSE="clippy cpu_flags_x86_sse2 debug doc miri nightly parallel-compiler rls rustfmt system-llvm test wasm ${ALL_LLVM_TARGETS[*]}"
...
RUST_DEP_PREV="$(ver_cut 1).$(($(ver_cut 2)))*"
