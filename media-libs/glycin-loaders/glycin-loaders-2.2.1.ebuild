...
MY_PV=${PV/_/.}
MY_P=glycin-${MY_PV}
TEST_IMAGE_COMMIT=75c95e4fe35d6d328a91f73d9225db9ee9e588d0
...
LICENSE+="
	Apache-2.0 Apache-2.0-with-LLVM-exceptions BSD GPL-3+ IJG ISC
...
RDEPEND="
	...
	heif? ( >=media-libs/libheif-1.20.0:= )
	jpegxl? ( >=media-libs/libjxl-0.11.1:= )
	svg? (
