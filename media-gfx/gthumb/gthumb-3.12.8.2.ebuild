...
IUSE="cdr colord geolocation gstreamer heif jpegxl lcms raw slideshow svg tiff webp"
...
src_prepare() {
	default
	sed -i 's/\btrue\b/TRUE/g' "${S}/extensions/image_rotation/rotation-utils.c" || die
}
