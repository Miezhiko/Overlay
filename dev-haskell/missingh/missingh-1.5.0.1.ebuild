...
RDEPEND=">=dev-haskell/hslogger-1.3.0.0:=[profile?] <dev-haskell/hslogger-1.4:=[profile?]
	...
	>=dev-lang/ghc-8.4.3:=
	network--ge-3-0-0? ( >=dev-haskell/network-3.0:=[profile?] <dev-haskell/network-3.2:=[profile?]
				>=dev-haskell/network-bsd-2.8.1:=[profile?] <dev-haskell/network-bsd-2.9:=[profile?] )
	!network--ge-3-0-0? ( >=dev-haskell/network-2.6.3.1:=[profile?] <dev-haskell/network-2.9:=[profile?] )
"
DEPEND="${RDEPEND}
...
src_configure() {
	haskell-cabal_src_configure \
		$(cabal_flag network--ge-3-0-0 network--ge-3_0_0)
}
