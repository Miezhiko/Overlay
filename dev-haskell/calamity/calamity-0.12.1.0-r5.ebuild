...
CABAL_CHDEPS=(
	...
	'crypton-x509-system   >=1.6.6   && <1.7' 'crypton-x509-system   >=1.6.6   && <2'
)
...
RDEPEND=">=dev-haskell/aeson-2.1:=[profile?] <dev-haskell/aeson-2.3:=[profile?]
	...
	>=dev-haskell/crypton-connection-0.2.6:=[profile?] <dev-haskell/crypton-connection-2:=[profile?]
	>=dev-haskell/crypton-x509-system-1.6.6:=[profile?] <dev-haskell/crypton-x509-system-2:=[profile?]
