...
RDEPEND=">=dev-haskell/base-compat-batteries-0.11:=[profile?] <dev-haskell/base-compat-batteries-0.15:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/base-orphans-0.8.5 <dev-haskell/base-orphans-0.10
		...
		>=dev-haskell/quickcheck-2.14.3 <dev-haskell/quickcheck-2.17
