...
RDEPEND=">=dev-haskell/optics-core-0.4.1:=[profile?] <dev-haskell/optics-core-0.4.3:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/indexed-profunctors-0.1 <dev-haskell/indexed-profunctors-0.2
		>=dev-haskell/inspection-testing-0.5 <dev-haskell/inspection-testing-0.6
