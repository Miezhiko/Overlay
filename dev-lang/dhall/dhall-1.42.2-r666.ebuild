...
CABAL_CHDEPS=(
  'template-haskell            >= 2.13.0.0 && < 2.23' 'template-haskell            >= 2.13.0.0 && < 3'
)

PATCHES=(
	"${FILESDIR}"/dhall-1.42.2-cabal-doctest.patch
)
...
RDEPEND=">=dev-haskell/aeson-1.0.0.0:=[profile?] <dev-haskell/aeson-2.3:=[profile?]
	...
	>=dev-haskell/diff-0.2:=[profile?] <dev-haskell/diff-1.1:=[profile?]
	...
	>=dev-haskell/unix-compat-0.4.2:=[profile?] <dev-haskell/unix-compat-0.8:=[profile?]
...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/doctest-0.7.0
		...
		>=dev-haskell/tasty-0.11.2 <dev-haskell/tasty-1.6
		<dev-haskell/tasty-expected-failure-0.13
		>=dev-haskell/tasty-hunit-0.10 <dev-haskell/tasty-hunit-0.11
		>=dev-haskell/tasty-quickcheck-0.9.2 <dev-haskell/tasty-quickcheck-0.12
		<dev-haskell/tasty-silver-3.4
		>=dev-haskell/temporary-1.2.1 <dev-haskell/temporary-1.4
		>=dev-haskell/turtle-1.6 <dev-haskell/turtle-1.7 )
...
src_prepare() {
  sed -i '/^deriving instance Lift Time\.Day$/d' "${S}/src/Dhall/Syntax/Instances/Lift.hs" || die
