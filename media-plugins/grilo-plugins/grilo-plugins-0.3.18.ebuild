...
EAPI=8
LUA_COMPAT=( lua5-{3,4} )
inherit gnome.org lua-single meson xdg vala
...
RDEPEND="
	...
	>=media-libs/grilo-0.3.15-r1:${SLOT}=
...
PATCHES=(
	"${FILESDIR}/0001-HACK-Disable-Tracker-tests.patch"
	"${FILESDIR}/0002-lua-xml-Fix-lua-tests.patch"
)
